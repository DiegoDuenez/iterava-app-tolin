...
<style>
    ...
    .landing__mask{
        ...
        z-index: 2;
        background-image:
        linear-gradient(to bottom, rgba(245, 246, 252, 0.747), rgba(0, 0, 0, 0.884));
    }
    ...
    .landing__input{
        width: 90%;
        background: rgba(219, 219, 219, 0.473);
        border-radius: 5px;
    ...
    .landing__search-button{
        background: rgba(219, 219, 219, 0.692);
        border: none;
        width: 10%;
